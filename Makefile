...
#    Updated: 2024/08/19 23:15:18 by aderison         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SO_LONGS_VIEW = $(addprefix view/, images.c draw_map.c window.c collision.c end_game.c move_ghost.c direction_pac.c)
