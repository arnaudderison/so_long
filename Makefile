...
#    Updated: 2024/08/22 13:24:58 by aderison         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SO_LONGS_VIEW = $(addprefix view/, images.c draw_map.c window.c collision.c end_game.c move_ghost.c direction_pac.c game_loop.c)
